document.addEventListener("DOMContentLoaded", () => {
  ...
  const content = [
    { type: 'h1', text: 'About Me', style: 'font-family: "VT323", monospace; font-size: 32px; margin-top: 10px; margin-bottom: 20px;' },
    { type: 'p', text: "Hi! I'm George, a developer passionate about creating web applications and exploring new technologies.", class: 'home___mainbox-text' },
    { type: 'p', text: 'I enjoy working on both frontend and backend development, with experience in JavaScript, Python, and various frameworks.', class: 'home___mainbox-text' },
    ...
    { type: 'h2', text: 'Skills', style: 'font-family: "VT323", monospace; font-size: 24px; margin-top: 20px; margin-bottom: 10px;' },
    { type: 'p', text: '• JavaScript / TypeScript\n• React / Vue.js\n• Node.js / Express\n• Python / Flask\n• HTML / CSS\n• Git / GitHub', class: 'home___mainbox-text' }
  ];
